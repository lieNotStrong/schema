...
public class PayOrderDemo {
    ...
    public static void main(String[] args) {
        new PayOrderDemo().order("20171225111118", "WeixinCS", null, "微信支付测试(服务器测试)",1,
                0, 0, 1,"201712250001", "4200000032201711144648000277", null, "下单接口",
                null, null, null, "http://localhost:8085/demo111/callback.do","1");
...
//                "", "订单标记", null, "http://10.14.158.27:8085/tlinx2apidemo1/callback/scanpay_cashier/payResult");
     ...
     */
    public void order(String outNo, String pmtTag, String pmtName, String ordName, Integer originalAmount,
                               ...
                               String jumpUrl, String notifyUrl,String cmd) {
...
/*String suborderId;
		...
		String SFJOrdertype;*/
            ...
            //for(int i=1;i<4;i++){
                ...
                dataMap.put("subamount", "0.01");// 子订单金额
